    ...
    <div class="item-form">
        ...
        <form action="{{ route('admin.infobox.infoboxes.update',$infobox) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="colored-rows-box">
                ...
                <div class="input-box colored">
                    <label>
                        <a href="{{ route('admin.infobox.properties.category.index',['infobox'=>$infobox]) }}">{{ __('infobox::elf.category_properties') }}</a>
                    </label>
                </div>
                <div class="input-box colored">
                    <label>
                        <a href="{{ route('admin.infobox.properties.item.index',['infobox'=>$infobox]) }}">{{ __('infobox::elf.item_properties') }}</a>
                    </label>
                </div>
                {{-- <div class="input-box colored">
